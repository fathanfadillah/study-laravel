...
@section('container')
  ...
  <div class="card-body text-success">
    <!-- <h5 class="card-title">Nama : {{$product->nama}}</h5> -->
    <p class="card-text float-left">{{$product->storage}} GB</p>
	<p class="card-text float-right">Rp{{$product->harga}},-</p>
  </div>
  <div class="card-footer border-success">
		<button type="submit" onclick="window.location.href='{{$product->id}}/edit';" class="btn btn-primary float-left">EDIT</button>
