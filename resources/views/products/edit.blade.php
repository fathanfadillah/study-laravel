  ...
  <div class="row">
    <div class="col">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm">
                <input type="text" name="nama" class="form-control" id="nama" placeholder="nama" value="{{$product->nama}}">
                @error('nama')
            ...
            <div class="form-group row">
              ...
              <div class="col-sm">
                <input type="text" name="storage" class="form-control" id="storage" placeholder="gb" value="{{$product->storage}}">
                @error('storage')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm">
                <input type="text" name="harga" class="form-control" id="harga" placeholder="rupiah" value="{{$product->harga}}">
                @error('harga')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
